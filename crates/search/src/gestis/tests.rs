...
fn test_parsing_cobaltdinitrat() {
  assert_eq!(
      make_parsed_data(
        ...
        Some("Gefahr"),
        Some(&["ghs03", "ghs05", "ghs07", "ghs08", "ghs09"]),
        Some("691 mg/kg"),
        None
      ),
...
fn test_parsing_calcium() {
  assert_eq!(
      make_parsed_data(
        ...
        Some(&[("P223", "Keinen Kontakt mit Wasser zulassen."), ("P232", "Vor Feuchtigkeit schützen."), ("P402+P404", "An einem trockenen Ort aufbewahren. In einem geschlossenen Behälter aufbewahren."), ("P501", "Entsorgung des Inhalts / des Behälters gemäß den örtlichen / regionalen / nationalen / internationalen Vorschriften.")]),
        Some("Gefahr"),
        Some(&["ghs02"]),
        None,
        None,
